ATTACHMENT.Base = "att_optic_10x_kv"
...
function ATTACHMENT:Stats(weapon)
	...
	weapon.ViewModelOffsets.Aim.Pos = weapon.ViewModelOffsets.Aim.Pos + Vector(-0.02,0,0.28)
	weapon.ViewModelOffsets.Aim.Angles = weapon.ViewModelOffsets.Aim.Angles + Angle(-0.005, -0.02, 0)
end
...
ATTACHMENT.VElement  = {
                ...
                Position = Vector(-0.055, -1.53, -0.06),
...
function ATTACHMENT:Stats(weapon)
    BaseClass.Stats(self, weapon)
        ...
        weapon.Recoil.Vertical[1] = weapon.Recoil.Vertical[1] * 1.35
        weapon.Recoil.Vertical[2] = weapon.Recoil.Vertical[2] * 1.35
        weapon.Recoil.Horizontal[1] = weapon.Recoil.Horizontal[1] * 1.35
        weapon.Recoil.Horizontal[2] = weapon.Recoil.Horizontal[2] * 1.35
end
...
ATTACHMENT.Name = "KRISS Defiance DS150"
ATTACHMENT.Model = Model("models/efttt/stock/ds150/ds150.mdl")
ATTACHMENT.Icon = Material("viper/mw/attachments/icons/eft/icon_ds150.vmt")
...
ATTACHMENT.VElement = {
    ...
    Position = Vector(-0.0575, -1.14, -0.06),
    Angles = Angle(0, 0, 0),
    Offsets = {}
}

...
ATTACHMENT.Name = "CTR"
ATTACHMENT.Model = Model("models/efttt/stock/ctr/stock_ar15_magpul_ctr_carbine.mdl")
ATTACHMENT.Icon = Material("viper/mw/attachments/icons/eft/icon_s_ctr.vmt")
...
ATTACHMENT.VElement = {
    ...
    Position = Vector(-0.055, -1.72, -0.06),
    Angles = Angle(0, 0, 0),
    Offsets = {}
}

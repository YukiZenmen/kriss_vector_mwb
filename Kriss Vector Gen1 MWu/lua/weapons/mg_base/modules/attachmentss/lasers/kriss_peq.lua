...
ATTACHMENT.Name = "PEQ-15"
ATTACHMENT.Model = Model("models/efttt/Laser/v_anpeq15_m4.mdl")
ATTACHMENT.Icon = Material("viper/mw/attachments/icons/eft/icon_peq15.vmt")
